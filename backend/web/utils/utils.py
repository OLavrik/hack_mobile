...
sample = pd.read_csv('web/static/data/sample.csv')
describe = pd.read_csv('web/static/data/describe.csv')
unique = pd.read_csv('web/static/data/unique.csv')
numeric = pd.read_csv('web/static/data/all_prepared_for_learn_prep1_del_bundle.csv')
...
def load_data():
    ...
    return sample, describe, unique, numeric, nan_dict, summury_class
